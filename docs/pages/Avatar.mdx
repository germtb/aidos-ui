...
Avatar owns badge placement while the existing Badge component owns its visual meaning. Badge placement is intentionally fixed rather than configurable.
