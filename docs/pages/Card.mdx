...
| ----------- | ------------------------------------ | ----------- | ------------------------------------- |
| `variant`   | `"default" \| "tonal" \| "floating"` | `"default"` | Structure and elevation treatment     |
...
<Row gap="large" align="stretch" jss={{ flexWrap: "wrap" }}>
  <Card material="aurora" jss={{ flex: "1 1 400px" }}>
    <H3>Aurora</H3>
    <P>Diffuse blue-green light.</P>
  </Card>
  <Card material="dawn" jss={{ flex: "1 1 400px" }}>
    <H3>Dawn</H3>
    <P>Pale sky with peach and gold.</P>
  </Card>
  <Card material="mist" jss={{ flex: "1 1 400px" }}>
    <H3>Mist</H3>
    <P>Neutral, milky diffusion.</P>
  </Card>
  <Card material="twilight" jss={{ flex: "1 1 400px" }}>
    <H3>Twilight</H3>
