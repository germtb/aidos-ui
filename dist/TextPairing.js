...
export function TextPairing({ headline, body, headlineColor = "primary", headlineSize = "medium", headlineAddOn, bodyColor = "secondary", bodySize = "medium", addOn, addOnPosition = "start", gap = "small", align = "stretch", grow, shrink, headlineBold, padding, jsStyle, }) {
    const textElement = (React.createElement(Column, { grow: grow, shrink: shrink, padding: addOn ? undefined : padding, align: align, jsStyle: [
        ...
        React.createElement(Row, { align: "center", jsStyle: {
            ...
            React.createElement(Text, { bold: headlineBold, color: headlineColor, size: headlineSize }, headline),
        ...
        body && (React.createElement(Row, { align: "center", jsStyle: {
            ...
            React.createElement(Text, { ellipsis: true, color: bodyColor, size: bodySize }, body)))));
    if (addOn) {
