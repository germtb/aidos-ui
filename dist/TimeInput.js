...
function TimeInputInternal({ time: date, onTimeChange: onDateChange, jss, addOn, padding = "small", gap = "none", addOnPosition = "start", bare, ...inputProps }, ref) {
    return (_jsxs(Row, { padding: padding, gap: gap, align: "center", jss: [
            {
