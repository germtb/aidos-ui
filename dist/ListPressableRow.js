...
export const ListPressableRow = React.forwardRef(({ onClick, href, headline, headlineSize = "medium", headlineColor = "primary", headlineAddOn, body, bodySize = "small", bodyColor = "secondary", addOn, addOnPosition, outerAddOn, color = "secondary", disabled = false, padding = "medium", jsStyle, gap, selected, bare, ...otherProps }, ref) => {
    ...
    return (React.createElement(BaseListRow, { relative: true, withDivider: !bare, ...otherProps, jsStyle: jsStyle },
        React.createElement(ListCell, { jsStyle: {
                ...
                flexGrow: 1,
                overflow: "hidden",
            } }, href != null ? (React.createElement(BaseLink, { "aria-selected": selected, disabled: disabled, animateInteraction: false, bare: true, color: color, href: href, ref: ref, jsStyle: pressabelJSStyle, "aria-label": headline, onPress: onClick, padding: padding }, textPairing)) : (React.createElement(BaseButton, { "aria-selected": selected, disabled: disabled, animateInteraction: false, bare: true, color: color, ref: ref, jsStyle: pressabelJSStyle, "aria-label": headline, onPress: onClick, padding: padding }, textPairing))),
