...
export const Button = React.forwardRef(({ children, color, bare, disabled, icon, iconSize = "medium", iconPosition = "left", align = "center", gap = "small", justify = "center", jss, size = "medium", bold, padding = "medium", ...otherProps }, ref) => {
    return (_jsx(BaseButton, { ...otherProps, bare: bare, ref: ref, color: color, disabled: disabled, padding: padding, jss: [
            {
