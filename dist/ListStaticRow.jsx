...
export const ListStaticRow = React.forwardRef(({ headline, headlineSize = "medium", headlineColor = "primary", body, bodySize = "small", bodyColor = "secondary", primaryAddOn, secondaryAddOn, background = "primary", ...otherProps }, ref) => {
    return (<BaseListRow {...otherProps} componentName={["ListStaticRowView"]} padding={primaryAddOn ? "none" : "medium"} jsStyle={[
            jsStyles.root,
        ...
        <BaseView componentName={["ListStaticRowView"]} jsStyle={jsStyles.view}>
          ...
          <Column componentName={["ListStaticRowView"]} jsStyle={jsStyles.textPairing}>
