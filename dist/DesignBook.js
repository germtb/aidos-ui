...
export function DesignBook() {
  const dialog = useDialog(
    ({ close }) => _jsx(ExampleDialog, { close: close }),
      ...
      children: [
          ...
          children: [
            ...
            _jsx(Row, {
              ...
              children: _jsx(Button, {
                ...
                color: "primary",
                onClick: () => {},
                children: "Bare secondary button",
              }),
            }),
            _jsx(Row, {
              gap: "medium",
        ...
        _jsxs(Sublist, {
          ...
          children: [
            ...
            _jsxs(Row, {
              ...
              gap: "medium",
              children: [
                _jsx(Icon, { size: "large", color: "light", icon: "fa-check" }),
                _jsx(Icon, {
                  size: "medium",
                  color: "light",
                  icon: "fa-check",
                }),
                _jsx(Icon, { size: "small", color: "light", icon: "fa-check" }),
              ],
            }),
          ],
        }),
        ...
        _jsxs(Sublist, {
          ...
          children: [
            _jsx(Row, {
              padding: "medium",
              gap: "medium",
              children: _jsx(TextPairing, { headline: "Headline" }),
            }),
            _jsx(Row, {
              padding: "medium",
              gap: "medium",
              children: _jsx(TextPairing, {
                headline: "Headline",
                body: "Body",
              }),
            }),
        ...
        _jsx(Sublist, {
          ...
          children: _jsx(Calendar, {
            date: new Date(),
            header: ({ weekday }) =>
              _jsx(Box, { children: _jsx(Text, { children: weekday }) }),
            cell: ({ today, date, outOfMonth }) =>
              _jsxs(Box, {
                relative: true,
                style: { opacity: outOfMonth ? 0.2 : 1 },
                children: [
                  today &&
                    _jsx(Badge, {
                      jss: {
