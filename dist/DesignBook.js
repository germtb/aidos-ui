    ...
    return (React.createElement(RootView, null,
        React.createElement(List, { navigation: false, ariaLabel: "Design book" },
            ...
            React.createElement(Sublist, { label: "Button", initialState: { collapsed: false } },
                React.createElement(Row, { gap: "medium" },
                    React.createElement(Button, { label: "Positive button", color: "positive", onClick: () => {
                            dialog.open();
                        } })),
                React.createElement(Row, { gap: "medium" },
                    React.createElement(PopoverTrigger, { PopoverComponent: ({ close }) => {
                            return (React.createElement(Popover, { close: close },
                                React.createElement(List, { navigation: false, ariaLabel: "Popover " },
                                    React.createElement(ListButtonItem, { gap: "medium", addOn: React.createElement(Icon, { size: "medium", color: "primary", icon: "fa-address-book" }), headline: "Option 1", onClick: () => { }, color: "positive" }),
                                    React.createElement(ListButtonItem, { gap: "medium", addOn: React.createElement(Icon, { size: "medium", color: "primary", icon: "fa-adjust" }), headline: "Option 2", onClick: () => { }, withDivider: false, color: "positive" }))));
                        } }, ({ toggle }) => (React.createElement(Button, { style: { position: "relative" }, label: "Secondary button", color: "secondary", onClick: () => {
                            toggle(undefined);
                        } })))),
                React.createElement(Row, { gap: "medium" },
                    React.createElement(PopoverTrigger, { PopoverComponent: ({ close }) => {
                            return (React.createElement(Popover, { close: close },
                                React.createElement(List, { ariaLabel: "Popover " },
                                    React.createElement(ListButtonItem, { gap: "medium", addOn: React.createElement(Icon, { size: "medium", color: "primary", icon: "fa-address-book" }), headline: "Option 1", onClick: () => { }, color: "positive" }),
                                    React.createElement(ListButtonItem, { gap: "medium", addOn: React.createElement(Icon, { size: "medium", color: "primary", icon: "fa-adjust" }), headline: "Option 2", onClick: () => { }, withDivider: false, color: "positive" }))));
                        } }, ({ toggle }) => (React.createElement(Button, { label: "Negative button", color: "negative", onClick: () => {
                            toggle(undefined);
                        } })))),
                React.createElement(Row, { gap: "medium" },
                    React.createElement(Tooltip, { content: "Tooltip here" },
                        React.createElement(Button, { label: "Disabled button", color: "positive", onClick: () => { }, disabled: true }))),
                React.createElement(Row, { gap: "medium" },
                    React.createElement(Button, { bare: true, label: "Bare positive button", color: "positive", onClick: () => { } })),
                React.createElement(Row, { gap: "medium" },
                    React.createElement(Button, { bare: true, label: "Bare secondary button", color: "secondary", onClick: () => { } })),
                React.createElement(Row, { gap: "medium" },
                    React.createElement(Button, { bare: true, label: "Bare negative button", color: "negative", onClick: () => { } })),
                React.createElement(Row, { gap: "medium" },
                    React.createElement(Button, { bare: true, label: "Bare disabled button", color: "positive", onClick: () => { }, disabled: true }))),
            ...
            React.createElement(Sublist, { label: "Icon button", initialState: { collapsed: false } },
                React.createElement(Row, { padding: "medium", gap: "medium" },
                    React.createElement(IconButton, { size: "large", icon: "fa-check", color: "positive", onClick: () => { } }),
                    React.createElement(IconButton, { size: "medium", icon: "fa-check", color: "positive", onClick: () => { } }),
                    React.createElement(IconButton, { size: "small", icon: "fa-check", color: "positive", onClick: () => { } }),
                    React.createElement(IconButton, { size: "large", icon: "fa-check", color: "positive", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { size: "medium", icon: "fa-check", color: "positive", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { size: "small", icon: "fa-check", color: "positive", onClick: () => { }, bare: true })),
                React.createElement(Row, { padding: "medium", gap: "medium" },
                    React.createElement(IconButton, { size: "large", icon: "fa-remove", color: "negative", onClick: () => { } }),
                    React.createElement(IconButton, { size: "medium", icon: "fa-remove", color: "negative", onClick: () => { } }),
                    React.createElement(IconButton, { size: "small", icon: "fa-remove", color: "negative", onClick: () => { } }),
                    React.createElement(IconButton, { size: "large", icon: "fa-remove", color: "negative", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { size: "medium", icon: "fa-remove", color: "negative", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { size: "small", icon: "fa-remove", color: "negative", onClick: () => { }, bare: true })),
                React.createElement(Row, { padding: "medium", gap: "medium" },
                    React.createElement(IconButton, { size: "large", icon: "fa-info", color: "secondary", onClick: () => { } }),
                    React.createElement(IconButton, { size: "medium", icon: "fa-info", color: "secondary", onClick: () => { } }),
                    React.createElement(IconButton, { size: "small", icon: "fa-info", color: "secondary", onClick: () => { } }),
                    React.createElement(IconButton, { size: "large", icon: "fa-info", color: "secondary", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { size: "medium", icon: "fa-info", color: "secondary", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { size: "small", icon: "fa-info", color: "secondary", onClick: () => { }, bare: true })),
                React.createElement(Row, { padding: "medium", gap: "medium" },
                    React.createElement(IconButton, { disabled: true, size: "large", icon: "fa-check", color: "positive", onClick: () => { } }),
                    React.createElement(IconButton, { disabled: true, size: "medium", icon: "fa-check", color: "positive", onClick: () => { } }),
                    React.createElement(IconButton, { disabled: true, size: "small", icon: "fa-check", color: "positive", onClick: () => { } }),
                    React.createElement(IconButton, { disabled: true, size: "large", icon: "fa-check", color: "positive", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { disabled: true, size: "medium", icon: "fa-check", color: "positive", onClick: () => { }, bare: true }),
                    React.createElement(IconButton, { disabled: true, size: "small", icon: "fa-check", color: "positive", onClick: () => { }, bare: true }))),
            React.createElement(ListSpacer, null),
            React.createElement(Sublist, { label: "Pressable list row", initialState: {
                    collapsed: false,
                } },
                React.createElement(ListButtonItem, { onClick: () => { }, headline: "Headline", color: "positive" }),
                React.createElement(ListButtonItem, { selected: true, onClick: () => { }, headline: "Selected", color: "positive" }),
                React.createElement(ListButtonItem, { onClick: () => { }, headline: "Headline", body: "Body", color: "positive" }),
                React.createElement(ListButtonItem, { onClick: () => { }, headline: "Disabled", body: "Body", disabled: true, color: "positive" }),
                React.createElement(ListButtonItem, { gap: "medium", addOn: React.createElement(Box, { padding: "medium" },
                        React.createElement(Icon, { size: "medium", color: "primary", icon: "fa-address-book" })), headline: "Really long body", body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", onClick: () => { }, color: "positive" })),
