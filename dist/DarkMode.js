...
export function DarkModeToggle() {
    ...
    if (!show) {
        return _jsx(BaseView, { jss: { width: 32, height: 32 } });
    }
    return (_jsx(IconButton, { "aria-label": "Toggle dark mode", icon: darkMode.enabled ? "fa-sun-o" : "fa-moon-o", size: "medium", onClick: darkMode.toggle, color: "primary", bare: true }));
}
