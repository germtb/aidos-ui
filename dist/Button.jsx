...
export const Button = React.forwardRef(({ children, color, bare, disabled, icon, iconSize = "medium", iconPosition = "left", align = "center", gap = "small", justify = "center", jsStyle, size = "medium", bold, padding = "medium", ...otherProps }, ref) => {
    return (<BaseButton {...otherProps} bare={bare} ref={ref} color={color} disabled={disabled} padding={padding} jsStyle={[
            {
